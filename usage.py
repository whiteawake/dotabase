    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Usage <font color="green">&#9563;</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: aqua;" title="How many times this item has been used this month.">Global Usage</th>
...
my_data = dotabase.execute('SELECT * FROM Items ORDER BY usage DESC')
