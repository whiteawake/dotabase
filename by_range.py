    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Range <font color="red">|</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: darkgoldenrod;">Attack Range</th>
...
hero_data = dotabase.execute('SELECT * FROM Hero ORDER BY range DESC')
