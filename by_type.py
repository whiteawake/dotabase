    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Type <font color="green">|</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: aqua;">Type</th>
...
my_data = dotabase.execute('SELECT * FROM Items ORDER BY type DESC')
