    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">First 10</a></li>
        ...
        <article id="boxedheroes">
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        <th class="header" style="color: darkgoldenrod; padding-bottom: 31px;" id="hero_header" title="All statistics are without item benefits."><br />Hero</th>
...
hero_data = dotabase.execute('SELECT * FROM Hero ORDER BY hero_name LIMIT 10')
