    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Trait <font color="red">|</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: darkgoldenrod;">Primary Trait</th>
...
hero_data = dotabase.execute('SELECT * FROM Hero ORDER BY trait')
