 ...
 * - `{{*}}` `put({string} key, {*} value)` 鈥� Puts a new key-value pair into the cache and returns it.
 ...
 *
 * - `always(callback)` 鈥� allows you to observe either the fulfillment or rejection of a promise,
...
function $RouteProvider(){
   ...
   *    - `template` 鈥� `{string=|function()=}` 鈥� html template as a string or function that returns
