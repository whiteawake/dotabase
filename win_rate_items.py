    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Win Rate <font color="green">|</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: aqua;" title="How many times this item has been used on a winning team this month.">Global Win Rate</th>
...
my_data = dotabase.execute('SELECT * FROM Items ORDER BY win_rate DESC')
