...
<html ng-app="heroViewer" style="overflow: hidden;">
    <head>
        <meta charset="UTF-8">
        <title>All Items - Dotabase</title>
    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">All Items <font color="green">&#9557;</font></a></li>
        ...
        <article id="boxeditems">
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        <th class="header" id="hero_header" style="color: aqua; padding-bottom: 31px;"><br />Item</th>
...
my_data = dotabase.execute('SELECT * FROM Items ORDER BY item_name')
