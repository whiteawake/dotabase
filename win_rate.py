...
<html ng-app="heroViewer" style="overflow: hidden;">
    <head>
        <meta charset="UTF-8">
        <title>By Win Rate - Dotabase</title>
    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Win Rate <font color="red">&#9563;</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: darkgoldenrod;" title="Global Win Rate (%)">Win Rate (%)</th>
...
hero_data = dotabase.execute('SELECT * FROM Hero ORDER BY win_rate DESC')
