...
<html ng-app="heroViewer" style="overflow: hidden;">
    <head>
        <meta charset="UTF-8">
        <title>By Damage - Dotabase</title>
    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Damage <font color="red">|</font></a></li>
        ...
        <article id="boxedheroes">
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        <th class="header" id="hero_header" style="padding-bottom: 31px;" title="All statistics are without item benefits."><br />Hero</th>
                        ...
                        <th class="header" style="color: darkgoldenrod;" title="Damage dealt by your hero at level 25.">Damage (max)</th>
...
hero_data = dotabase.execute('SELECT * FROM Hero ORDER BY max_damage DESC')
