...
number = random.randrange(1, 134)
name = form.getvalue('name')
trait = form.getvalue('trait')
allegiance = form.getvalue('allegiance')
strength = form.getvalue('strength')
agility = form.getvalue('agility')
intelligence = form.getvalue('intelligence')
movement = form.getvalue('movement')
armour = form.getvalue('armour')
min_damage = form.getvalue('min_damage')
max_damage = form.getvalue('max_damage')
range_ = form.getvalue('range_')
    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li><a class="menu" href="all.py#">All Heroes <font color="red">&#9557;</font></a></li>
        ...
        <h1 class="banner" style="width: 100px;">Success</h1>
			<h2 class="banner"> 
				Hero added to database:</h2><font color="white"><p><br />"""
				+ 'Hero name: ' + str(name) + '<br />' 
                + 'Trait: ' + str(trait) + '<br />' 
                + 'Allegiance: ' + allegiance + '<br />' 
                + 'Strength: ' + str(strength) + '<br />'
                + 'Agility: ' + str(agility) + '<br />' 
                + 'Intelligence: ' + str(intelligence) + '<br />' 
                + 'Movement Speed: ' + str(movement) + '<br />' 
                + 'Armour: ' + str(armour) + '<br />' 
                + 'Damage (min): ' + str(min_damage) + '<br />' 
                + 'Damage (max): ' + str(max_damage) + '<br />' 
                + 'Range: ' + str(range_) + '<br />' 
                + 'Win Rate (%): ' + str(rate) +
				"""
