    ...
    <body style="margin: 0px">
        <nav>
            <ul>
                ...
                <li class="current"><a class="menu" href="#/heroes">by Damage <font color="green">|</font></a></li>
            ...
            <table class="dota" data-table-sortable="yes">
                <thead>
                    <tr>
                        ...
                        <th class="header" style="color: aqua;" title="How much damage is dealt by the item (if applicable).">Damage</th>
...
my_data = dotabase.execute('SELECT * FROM Items ORDER BY damage DESC')
